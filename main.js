...
function btnClicked() {
  ...
  document.getElementById('d1-ticket').innerHTML = speedingCalc(d1Speed, d1Limit);
  document.getElementById('d2-ticket').innerHTML = speedingCalc(d2Speed, d2Limit);
  document.getElementById('d3-ticket').innerHTML = speedingCalc(d3Speed, d3Limit);
}
function speedingCalc(speed, limit) {
  let ticket;
  if (speed > limit + 40) {
